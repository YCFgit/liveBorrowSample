...
本文档基于 [legacy-h5-demo-v1.5.html](../../examples/legacy-h5-demo-v1.5.html) 提炼一张适合钉钉卡片发送的业务卡片，而不是把整份 H5 原样搬进钉钉卡片。
...
- H5 联调页中的“互动卡片测试”
- 默认写入模板 ID：`2fec46db-af53-4730-b9c4-64a23fd2351e.schema`
